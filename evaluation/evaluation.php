    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            <div class="card-tools">
                <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=evaluation/new_evaluation"><i class="fa fa-plus"></i> Add New Evaluation</a>
            ...
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                        <td><b><?php echo number_format($performance_average, 2)."%" ?></b></td>
                        <!-- ?|<td><b><?php echo $prediction; ?></b></td> -->
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <a class="dropdown-item" href="./index.php?page=evaluation/edit_evaluation&id=<?php echo $row['id'] ?>">Edit</a>
                                <div class="dropdown-divider"></div>
...
<script>
    $(document).ready(function(){
        ...
        $('.view_evaluation').click(function(){
            uni_modal("Evaluation Details","evaluation/view_evaluation.php?id="+$(this).attr('data-id'),'mid-large');
        });
